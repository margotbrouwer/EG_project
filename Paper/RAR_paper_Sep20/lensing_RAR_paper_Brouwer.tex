...
\begin{itemize}
	...
	\item Fig.~\ref{fig:RAR_kids_dwarfs}: We found no significantly different RAR, relative to the entire sample, for a subsample of the lightest GL-KiDS lenses: isolated $M_* < 10^{10} \hmsun$ `dwarf' galaxies.
